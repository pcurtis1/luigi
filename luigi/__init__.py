...
from luigi.task import Task, SoftFailTask, Config, ExternalTask, WrapperTask, namespace, auto_namespace
...
__all__ = [
    'task', 'Task', 'SoftFailTask', 'Config', 'ExternalTask', 'WrapperTask', 'namespace', 'auto_namespace',
